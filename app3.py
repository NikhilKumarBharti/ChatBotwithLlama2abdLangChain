...
API_KEY = "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"
...
def load_llm():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        device_map="auto",
        use_auth_token=True,
        api_key=API_KEY  # Provide the API key here
    )
...
if uploaded_file:
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ["Hello ! Ask me anything about the Airline Review 🤗"]
